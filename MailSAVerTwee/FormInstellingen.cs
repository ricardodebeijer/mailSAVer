...
namespace MailSAVerAddin
{
    public partial class FormInstellingen : Form
    {
        ...
        {
            lbNamen.Items.Clear();
            foreach (String naam in MailSAVerTwee.Properties.Settings.Default.EmailUitgaand)
            {
        ...
        {
            MailSAVerTwee.Properties.Settings.Default.Save();
            MailSAVerTwee.Properties.Settings.Default.Reload();
        }
        ...
        private void btnNaamToevoegen_Click(object sender, EventArgs e)
        {
            if (tbNaam.Text != "")
            {
                if (!MailSAVerTwee.Properties.Settings.Default.EmailUitgaand.Contains(tbNaam.Text))
                {
                    MailSAVerTwee.Properties.Settings.Default.EmailUitgaand.Add(tbNaam.Text);
                    SaveAndReload();
                }
                else
                {
        ...
        private void btnNaamVerwijder_Click(object sender, EventArgs e)
        {
            ...
            {
                MailSAVerTwee.Properties.Settings.Default.EmailUitgaand.Remove(lbNamen.SelectedItem.ToString());
                SaveAndReload();
                VulNamenEmailUitgaand();
            }
        }
        ...
        private void btnLocatieZetStandaard_Click(object sender, EventArgs e)
        {
            ...
            {
                InstellingString selected = (InstellingString)lbLocaties.SelectedItem;
                String padoudestandaard = MailSAVerTwee.Properties.Settings.Default.LocatieStandaard;
